        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex space-x-5 pt-2">
              <a href={facebookLink} target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-800 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all"><Facebook size={20} /></a>
              <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-800 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all"><Instagram size={20} /></a>
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="p-2 border border-gray-800 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed font-medium">Based in Pakistan, we aim to bridge the gap between quality and affordability with our handpicked collections.</p>
          </div>
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#D4AF37] mb-8">Contact Us</h4>
            <ul className="space-y-4 text-sm font-medium text-gray-400">
              <li className="flex items-start gap-3"><MapPin size={18} className="text-[#D4AF37] shrink-0" /><span>Azizabad, Karachi 75950, Pakistan</span></li>
              <li className="flex items-center gap-3"><Phone size={18} className="text-[#D4AF37] shrink-0" /><a href={whatsappLink} target="_blank" className="hover:text-white">0328 2519507</a></li>
              <li className="flex items-center gap-3"><Mail size={18} className="text-[#D4AF37] shrink-0" /><a href="mailto:kevin11.shop@proton.me" className="hover:text-white underline decoration-[#D4AF37] decoration-2 underline-offset-4">kevin11.shop@proton.me</a></li>
            </ul>
          </div>
        </div>
      </div>
